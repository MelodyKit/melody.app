    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          /></router-link>
          <h1 class="text-xl text-neutral-900 md:text-2xl dark:text-neutral-50">Reset password</h1>
          <form class="space-y-4 md:space-y-6" @submit.prevent="reset">
            <div>
              <label for="token" class="block mb-2 text-neutral-900 dark:text-neutral-50"
                >Temporary token</label
              >
              <input
                type="password"
                name="token"
            ...
            <div>
              <label for="password" class="block mb-2 text-neutral-900 dark:text-neutral-50"
                >Password</label
              >
              <input
                type="password"
            ...
            <div>
              <label for="confirm" class="block mb-2 text-neutral-900 dark:text-neutral-50"
            ...
            <div class="flex items-center justify-between">
              <p class="text-neutral-600 dark:text-neutral-500">
                Note: changing the password revokes all sessions!
              </p>
            </div>
            <button
              type="submit"
