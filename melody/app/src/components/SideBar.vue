    ...
    <div class="hidden bg-neutral-50 dark:bg-black lg:block w-full px-4 py-2">
      <div class="divide-y divide-neutral-200 dark:divide-neutral-700">
        <div>
          <div class="pb-4">
            <div class="flex items-center px-2 pb-4 gap-x-4">
              <button type="button" @click="router.back()">
                <i
                  class="fa-solid fa-arrow-left w-5 h-auto text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50"
                ></i>
              </button>
              <button type="button" @click="router.forward()">
                <i
                  class="fa-solid fa-arrow-right w-5 h-auto text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50"
                ></i>
              </button>
            </div>
            <router-link
              :class="[
                'flex items-center px-2 pb-4 gap-x-4',
                isHome
                  ? 'text-melody-blue'
          ...
          <div class="pb-4">
            <button
              class="flex items-center px-2 pb-4 gap-x-4 text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50"
            >
